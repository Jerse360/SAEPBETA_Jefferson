...
$(function () {
    ...
    var progreso = <?php echo isset($_SESSION['progreso']) ? $_SESSION['progreso'] : 0; ?>;
    ...
    function animarBarraProgreso() {
      ...
      var porcentajeFinal = <?php echo isset($_SESSION['progreso']) ? $_SESSION['progreso'] : 0; ?>;
      var porcentajeActual = 0;
      var velocidad = 20; // ms entre cada incremento
      var incremento = 1; // Porcentaje a incrementar en cada paso
